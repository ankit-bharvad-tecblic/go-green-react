...
const schema = yup.object().shape({
  ...
  client: yup.array().of(
    yup.object().shape({
      ...
      reservation_period_month: yup
        .string()
        .required("reservation period is required"),
...
const WmsRent = ({ id }) => {
  ...
  const ClientErrorFunction = () => {
    setClientError({
      ...
      qty: clientList.qty === "" ? "error" : "",
      period: clientList.period === "" ? "error" : "",
      start_data: clientList.start_date === "" ? "error" : "",
      end_date: clientList.end_date === "" ? "error" : "",
    });
  };
  ...
  const append_client_list = () => {
    if (ClientErrorStatus()) {
      add_client_list({
        ...
        reservation_start_date: clientList.start_date,
        reservation_end_date: clientList.end_date,
      });
      setClientDripDown((item) => [
        ...item,
        {
  ...
  const updateClientFunction = (data, id) => {
    ...
    setClientList({
      ...
      start_date: data.reservation_start_date,
      end_date: data.reservation_end_date,
    });
    ClientErrorClear();
  };
                            ...
                            >
                              ...
                              <GridItem>
                                ...
                                <Input
                                  ...
                                  style={inputStyle}
                                  borderColor={
                                    clientError.period ? "red" : "gray.10"
                                  }
                                />
                              </GridItem>
                              <GridItem>
                                ...
                                <Input
                                  ...
                                  type="date"
                                  value={clientList.start_date}
                                  onChange={(val) => {
                                    ClientOnChange(val, "start_date");
                                  }}
                                  border="1px"
                                  style={inputStyle}
                                  borderColor={
                                    clientError.start_date ? "red" : "gray.10"
                                  }
                                />
                              </GridItem>
                              <GridItem>
                                ...
                                <Input
                                  ...
                                  type="date"
                                  value={clientList.end_date}
                                  onChange={(val) => {
                                    ClientOnChange(val, "end_date");
                                  }}
                                  border="1px"
                                  style={inputStyle}
                                  borderColor={
                                    clientError.end_date ? "red" : "gray.10"
                                  }
                                />
                              </GridItem>
                              <GridItem
